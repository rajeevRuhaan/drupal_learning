...
namespace Drupal\session\EventSubscriber;

use Drupal\session\Event\UserLoginEvent;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;

/**
 * Class UserLoginSubscriber.
 *
 * @package Drupal\session\EventSubscriber
 */
class UserLoginSubscriber implements EventSubscriberInterface {
   ...
   *
   * @param \Drupal\session\Event\UserLoginEvent $event
   *   Dat event object yo.
   */
